...
const newColumns=data.addDatesSubs();
//filtering the data from rows to get all those rows who's status is approved
const filterRows=data.rows.filter(item=>item.status.includes("Subscribed"))
...
function subscribed(){
  return(
    ...
    <br/>
    <TaskBar tools={<FullScreen title="Subscribed" tableRows={filterRows} tableColumns={newColumns} height={'100vh'} rowsPerPage={10}/>}/>
