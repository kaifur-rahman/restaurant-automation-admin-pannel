...
const filterRows=data.rows.filter(item=>item.status.includes("Pending"))
...
function pending(){
  return(
    ...
    <Title title="Pending"/>
    <br/>
    <TaskBar tools={<FullScreen title="Pending" tableRows={filterRows} tableColumns={newColumns} height={'100vh'} rowsPerPage={10}/>
}/>
