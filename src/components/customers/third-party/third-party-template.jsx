...
const filterRows=data.rows.filter(item=>item.origin.includes("Third Party"))

function totalList(){
  return(
    <div>
    <Title title="Third Party"/>
    <br/>
    <Box display="flex" justifyContent="right">
    <TaskBar tools={<FullScreen sx={{align:"right"}} title="Third Party"  tableRows={filterRows} tableColumns={newColumns} height={'100vh'} rowsPerPage={10}/>}/>
    </Box>
