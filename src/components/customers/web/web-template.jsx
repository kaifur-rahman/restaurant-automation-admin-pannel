...
const filterRows=data.rows.filter(item=>item.origin.includes("Web"))
...
function totalList(){
  return(
    ...
    <TaskBar tools={<FullScreen sx={{align:"right"}} title="Web"  tableRows={filterRows} tableColumns={newColumns} height={'100vh'} rowsPerPage={10}/>}/>
    </Box>
